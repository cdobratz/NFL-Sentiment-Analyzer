...
from .api import auth, sentiment, data, admin, websocket, mlops, analytics, health, api_keys, docs
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting NFL Sentiment Analyzer...", extra={"correlation_id": get_correlation_id()})

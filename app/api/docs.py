...
async def api_info():
    ...
    return {
        ...
        "rate_limits": {
            ...
            "user_roles": {
                "user": {"per_minute": 100, "per_hour": 5000, "per_day": 50000},
                "admin": {"per_minute": 1000, "per_hour": 50000, "per_day": 500000},
            },
...
async def list_api_scopes():
    ...
    scopes = [
        ...
        },
        {
            ...
            "endpoints": ["POST /sentiment/analyze", "POST /sentiment/batch"],
        },
        {
        ...
        },
        {
            ...
            "endpoints": ["POST /data/teams", "POST /data/players"],
        },
        {
        ...
        },
        {
            ...
            "endpoints": ["All endpoints (equivalent to admin user role)"],
        },
    ]

...
class RateLimiter:
    ...
    def _get_redis_key(self, identifier: str, limit_type: RateLimitType, endpoint: str = None) -> str:
    ...
    async def check_multiple_limits(
        ...
        for limit_type in [RateLimitType.PER_MINUTE, RateLimitType.PER_HOUR, RateLimitType.PER_DAY]:

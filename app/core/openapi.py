...
- **Correlation IDs**: Include correlation ID from response headers when reporting issues
        ...
        routes=app.routes,
        servers=[
            {"url": "https://api.nflsentiment.com", "description": "Production server"},
            {
    ...
    openapi_schema["tags"] = [
        ...
        {"name": "Analytics", "description": "Historical analytics and trend analysis"},
        {
            "name": "Admin",
...
def setup_openapi_docs(app: FastAPI):
    ...
    app.description = (
        "Advanced NFL Sentiment Analysis Platform with Real-time Data Processing"
    )

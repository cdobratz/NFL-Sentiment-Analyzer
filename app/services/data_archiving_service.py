...
class DataArchivingService:
    ...
    async def archive_old_sentiment_data(self) -> Dict[str, int]:
        ...
        try:
            ...
            logger.info(f"Archiving completed: {archived_count} documents archived, {deleted_count} deleted from active")
    ...
    async def delete_old_archived_data(self) -> Dict[str, int]:
        ...
        try:
            ...
            logger.info(f"Deletion completed: {deleted_count} documents deleted from archive")
    ...
    async def cleanup_deleted_data(self, older_than_days: int = 30) -> int:
        ...
        logger.info(f"Permanently deleted {result.deleted_count} documents from deleted collection")

...
class DataIngestionService:
    ...
    async def collect_twitter_data(self, keywords: List[str], max_results: int = 100) -> List[RawDataItem]:
        """
    ...
    async def fetch_espn_data(self, game_ids: Optional[List[str]] = None) -> List[RawDataItem]:
        """
    ...
    async def get_betting_lines(self, sportsbooks: List[str] = None) -> List[RawDataItem]:
        """
